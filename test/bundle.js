...
function keyFromPassword(password, salt) {
    ...
    return global.crypto.subtle.importKey('raw', passBuffer, { name: 'PBKDF2' }, false, ['deriveBits', 'deriveKey']).then(function (key) {
        return global.crypto.subtle.deriveKey({ name: 'PBKDF2',
            salt: saltBuffer,
            iterations: 10000,
            hash: 'SHA-256',
...
},{"browserify-unibabel":3}],2:[function(require,module,exports){
'use strict'
